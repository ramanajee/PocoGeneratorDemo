...
namespace Pocogeneratortest.Context
{
    ...
    public class DigitalAdminDbContext : System.Data.Entity.DbContext, IDigitalAdminDbContext
    {
        ...
        static DigitalAdminDbContext()
        {
            System.Data.Entity.Database.SetInitializer<DigitalAdminDbContext>(null);
        }

        public DigitalAdminDbContext()
            : base("Name=DigitalAdministrationContext")
        {
        }

        public DigitalAdminDbContext(string connectionString)
            : base(connectionString)
        {
        }

        public DigitalAdminDbContext(string connectionString, System.Data.Entity.Infrastructure.DbCompiledModel model)
            : base(connectionString, model)
        {
        }

        public DigitalAdminDbContext(System.Data.Common.DbConnection existingConnection, bool contextOwnsConnection)
            : base(existingConnection, contextOwnsConnection)
        {
        }

        public DigitalAdminDbContext(System.Data.Common.DbConnection existingConnection, System.Data.Entity.Infrastructure.DbCompiledModel model, bool contextOwnsConnection)
